...
be written as
\begin{align}\label{eq:carrier_spin_population}
...
\begin{align}\label{eq:carrier_spin_tensors}
...
Working with the transitions expressions (Eq. \ref{eq:electron_1_contribution})
% \begin{subequations}
\begin{align*}
